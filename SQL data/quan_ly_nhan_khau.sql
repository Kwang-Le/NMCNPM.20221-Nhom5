...
CREATE TABLE `cach_ly` (
    ...
    `noiCachLy` VARCHAR(255) COLLATE utf8_unicode_ci DEFAULT NULL,
    `thoiGianBatDau` date DEFAULT NULL,
    `mucDoCachLy` VARCHAR(255) COLLATE utf8_unicode_ci DEFAULT NULL,
    `daKiemTra` VARCHAR(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `kiem_tra` (
    ...
    `hinhThucTest` VARCHAR(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `khai_bao` (
  ...
  `vungDich` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
