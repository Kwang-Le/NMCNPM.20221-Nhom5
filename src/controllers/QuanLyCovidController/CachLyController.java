...
package controllers.QuanLyCovidController;

import com.toedter.calendar.JDateChooser;
import models.CachLy;
import services.QuanLyCovidService.CachLyService;
import services.QuanLyCovidService.CachLyServiceImpl;
        ...
        btnSubmit.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if(jtfHoTen.getText().length() == 0 || jtaNoiCachLy.getText() == null){
                    ...
                    cachLy.setThoiGianBatDau((Date) new Date(jdcThoiGianBatDau.getDate().getTime()));
